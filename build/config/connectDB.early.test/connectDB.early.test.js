...
jest.mock("sequelize", function () {
  var authenticateMock = jest.fn();
  var SequelizeMock = jest.fn(function () {
    return {
...
describe("connectDB() connectDB method", function () {
  ...
  describe("Happy Paths", function () {
    it("should successfully connect to the database", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
  ...
  describe("Edge Cases", function () {
    it("should handle authentication failure gracefully", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.n) {
          case 0:
            ...
            consoleErrorSpy = jest.spyOn(console, "error").mockImplementation(function () {}); // Act: Call the connectDB function
            _context2.n = 1;
            return connectDB();
          case 1:
