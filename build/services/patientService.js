...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } //import database from models:
//tham số môi trường
require("dotenv").config();
//Data truyền từ controller sang service:
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          ...
          case 4:
            resolve({
              errCode: 0,
              errMessage: "Save infor pattientApointment succeed"
            });
          case 5:
            _context.n = 7;
            break;
        ...
        while (1) switch (_context2.p = _context2.n) {
          ...
          case 1:
            ...
            return _index["default"].Booking.findOne({
              ...
              //raw: false mới dùng dược hàm update.==> Trả ra object của sequelize
              raw: false
            });
          case 2:
