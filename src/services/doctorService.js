...
let saveDetailInforDoctor = (inputData) => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      // console.log('trbui check state 2: ',inputData.doctorId,"contentMarkdown:  ",inputData.contentMarkdown,"contentHTML: ",inputData.contentHTML,inputData.description);
    } catch (e) {
      reject(e);
    }
  });
